...
namespace gargantuan {
	// The subset of Roblox's Material enum that carries distinct physical
	// properties. Rendering-only materials can be added without touching this.
	G_ENUM(
		Material,
